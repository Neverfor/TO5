...
Niet genoeg? Koop ze <a href='<s:url action="gotockopen" namespace="/gebruiker"/>'>hier</a> of start met bieden. Klopt iets niet bij je
gegevens? Wijzig ze <a href='<s:url action="gotowgegevens" namespace="/gebruiker"/>'>hier</a>.</p>